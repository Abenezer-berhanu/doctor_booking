...
function AboutFooter() {
  return (
    <div className="my-5 w-full relative mx-auto min-h-[400px] flex items-center">
      <div className="w-1/2 sml:bg-primary h-full right-0 absolute -z-10"></div>
      <div className="w-full h-full p-5 grid gap-2 sml:grid-cols-5">
        ...
        <div className="col-span-1 bg-bg_white_gray dark:bg-bg_black flex flex-col gap-3 items-center p-2">
